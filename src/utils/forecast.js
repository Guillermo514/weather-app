...
const forecast = (latitud, longitud, callback) => {
    ...
    request({ url: url, json: true}, (error, {body}) => {
        if (error) {
            ...
            // })
            callback(undefined, 'Hay una temperatura de ' + body.current.temperature + ' Cº con una precipitacion de ' + body.current.precip + ' y un dia ' + body.current.weather_descriptions)
